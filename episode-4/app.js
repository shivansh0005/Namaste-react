...
<div className="header">
    <div className="logo-container">
        <img className="logo" src=" https://www.logodesign.net/logo/smoking-burger-with-lettuce-3624ld.png?industry=COMPANY+NAME" alt="" srcset="" />
    </div>
...
const resObj = [
    ...
    },
    {
      ...
      data: {
        ...
        cloudinaryImageId: "byoxd1zylbqegjkie1pm",
    ...
    },
    {
      ...
      data: {
        ...
        area: "Athwa",
        totalRatingsString: "1000+ ratings",
        cloudinaryImageId: "RX_THUMBNAIL/IMAGES/VENDOR/2024/7/17/9318ae22-5fa2-4950-9cf1-37920ae76d93_78973.jpg",
...
//             <img  className ="res-logo"src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/RX_THUMBNAIL/IMAGES/VENDOR/2024/4/17/34bdc0b9-123a-44a8-b07a-12055c8ba41f_73011.JPG" alt="logo" srcset="" />
//             <h3>{resData.name}</h3>
    ...
    <div className="body">
      ...
      <div className="res-container">
        {resObj.map((restaurant) => (
          <ResturantCard key={restaurant.data.id} resData={restaurant.data} />
        ))}
      </div>
    </div>
  );
